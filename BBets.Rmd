...
MyData = numeric(1000)
for (i in 1:1000) {
  MyData[i]=BrLw(countoDo = 1, numClass = 35, odds =2)
}
sMyData = sort(MyData)
low=sMyData[25]
high=sMyData[975]
...
for (i in 1:1000) {
  MyData2[i] = BrLw(countoDo = 1, numClass = 35, odds = 4.38)  
}
...
for (i in 1:1000) {
  MyData3[i] = BrLw(countoDo = 1,numClass = 29, odds =2)  
}
...
He made in a 95% confidence interval an interval from 223-340 dollars with an average of 281. 
